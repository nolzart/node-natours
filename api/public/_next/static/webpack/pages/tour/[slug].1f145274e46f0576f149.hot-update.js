...
const DetailItem = ({
  ...
  lineNumber: 17,
  columnNumber: 5
}, undefined); // export const getServerSideProps = wrapper.getServerSideProps(async ({ store, params }) => {
...
/***/ "./store/reducers/alertReducer.js":
false,
