...
TourDetails.getInitialProps = async ({
  ...
  return await store.dispatch(_store_actions_tourActions__WEBPACK_IMPORTED_MODULE_10__["getTour"](req.params.slug));
};
