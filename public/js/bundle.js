...
var showAlert = function showAlert(status, msg) {
  hideAlert();
  var markup = "<div class='alert alert--".concat(status, "'>").concat(msg, "</div>");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alert.showAlert)('error', 'Something was wrong! Try again.');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            if (res.data.status === 'success') (0, _alert.showAlert)('success', "".concat(type[0].toUpperCase()).concat(type.substring(1), " updated successfully"));
            _context.next = 11;
            break;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoibm9semFydCIsImEiOiJja2hhcmYyOGEwOGtsMnluOHZwZTJ2NXFlIn0.HPmAIutT5cIh1Hs3BiAphg';
...
var stripe = Stripe ? Stripe('pk_test_51HnrF2KyEVMDo9Wn6KEslURceFslGebjrSODFs03WIqCuwsZeVKKZ3OWtR3wpnyzZnqFLdlc6jImGCPdVppmF6ON00NAZU5OLi') : '';

exports.getCheckoutSession = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Something was wrong!');
...
var bookingBtn = document.getElementById('book-tour'); // Data
...
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout); // Update
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--password').textContent = 'Save password'; // Clean form
