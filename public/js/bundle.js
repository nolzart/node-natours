      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            if (_context.t0.response.data.message) (0, _alert.showAlert)('error', _context.t0.response.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            (0, _alert.showAlert)('error', 'Problem update data');
...
var formUpdateUserData = document.querySelector('.form-user-data'); // Data
...
if (formUpdateUserData) formUpdateUserData.addEventListener('click', function (e) {
  e.preventDefault();
